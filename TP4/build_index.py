...
# Recherchez un modèle d'embedding multilingual sur Ollama
EMBEDDING_MODEL = "nomic-embed-text-v2-moe"  # Il est recommendé de prendre un modèle d'embedding multilingual(à chercher sur Ollama directement)
